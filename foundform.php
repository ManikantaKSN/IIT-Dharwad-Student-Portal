...
<a href="home.php" style="text-decoration:none;"><header>
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if (move_uploaded_file($_FILES["file"]["tmp_name"], $target_file)) {
          ...
          $sql = "INSERT INTO found_items (name, roll_number, Location, item_name, contact_number, file) VALUES ('$name', '$roll_no', '$location', '$item_name', '$contact_no', '$file_path')";
  ...
  <form action="#" method="post" enctype="multipart/form-data">
    <h2 style="color: white;">Found Item Report Form</h2>
